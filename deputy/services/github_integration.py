...
from deputy.models.issue import ThreadAnalysis, GitHubIssue, IssueCreationConfig
...
class GitHubIntegration:
    ...
    async def create_issue_from_analysis(
        ...
        mattermost_link: Optional[str] = None
    ) -> str:
        ...
        try:
            ...
            try:
                ...
                raise Exception(f"Repository access failed: {repo_error}")
    ...
    def _analysis_to_github_issue(
        ...
        if mattermost_link:
            ...
            body_parts.append(f"[View original thread in Mattermost]({mattermost_link})")
            body_parts.append("")
